...
const PlaceAutoComplete = ({
  ...
  return (
    <div
      className={`w-full gap-2 ${boxClass ? boxClass : 'border border-fg-grey rounded-lg'} flex border-none hover:scale-105 transition-all duration-300 hover:translate-x-3`}
    >
      {showGlass && (
