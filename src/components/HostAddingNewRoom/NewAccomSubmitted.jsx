...
const AccommodationSubmitSuccess = () => (
  <div className='flex flex-col items-center justify-center h-[700px] bg-white'>
    <div className='mb-8'>
    ...
    <div className='bg-white-border border-[2px] border-gray-200 shadow-lg rounded-xl w-[800px] h-[500px] flex flex-col justify-center items-center p-6'>
      <div className='flex flex-col justify-center bg-fg-primary-03 bg-opacity-80 w-[700px] h-[400px] p-8 rounded-lg shadow-lg text-center'>
        ...
        <p className='mb-4'>
          {' '}
          Your accommodation is waiting for the approval. <br />
          We will let you know when your accommodation is approved and ready to
          active{' '}
        </p>
      </div>
    </div>
